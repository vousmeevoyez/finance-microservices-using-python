...
from rpc.lib.core.remote_call import fetch
from rpc.factories import generate_request, generate_response
...
from rpc.lib.core.remote_call import FetchError
...
class BaseProvider:
    ...
    def __init__(self, *args, **kwargs):
        ...
        request = generate_request(self.contract)
        response = generate_response(self.contract)
    ...
    async def call(self):
        ...
        try:
            response = await fetch(self.request_contract, self.response_contract)
