...
from rpc.lib.helper import decrypt, DecryptError
...
class BNICreditEcollectionResponse(AsyncHTTPResponse):
    ...
    def decrypt(self, response):
        ...
        try:
            decrypted_data = decrypt(self.client_id, self.secret_key, response["data"])
        except DecryptError:
