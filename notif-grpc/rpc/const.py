...
EMAIL_STATIC = {
    "MOPINJAM": {
        ...
        "INFO":
          "Jika Anda memiliki pertanyaan dalam menggunakan layanan kami, silahkan hubungi kami di cs@mopinjam.id atau via telp di (021)-22586111 atau via WhatsApp di 08119790000.",
        "THANKS": "Terima kasih atas perhatian dan kerjasamanya.",
        "CHEERS": "Hormat Kami,",
        "TEAM_NAME": "Mopinjam",
        "STREET1": "Puri Indah Financial Tower",
        "STREET2":
          "Jakarta Barat, Kembangan Selatan, Daerah Khusus Ibukota Jakarta 11610.",
        "COPYRIGHT":
          "© " + "2019"
