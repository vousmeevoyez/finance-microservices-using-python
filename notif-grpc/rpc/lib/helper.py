...
from rpc.lib.template import generate_email_template, generate_notification_template
...
def send_email(recipient, product_type, email_type, content=None, filename=None):
...
def send_push_notification(device_token, notif_type, product_type, content=None):
    # generate mobile template
    subject, message = generate_notification_template(
        notif_type=notif_type, product_type=product_type, encoded_content=content
    )
